...
dtNavMesh* Sample::loadAllFromUnityNavMesh(const char* path)
{
	float boundBoxMin[3] = {0.0f, 0.0f, 0.0f};
	float boundBoxMax[3] = { 0.0f, 0.0f, 0.0f };
	return NavMeshImporter_Unity(path, boundBoxMin, boundBoxMax);
}
